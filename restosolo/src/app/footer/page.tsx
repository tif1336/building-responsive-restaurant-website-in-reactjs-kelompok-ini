      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/4">
            <h2 className="font-bold text-4xl text-white mb-5">{profile.length > 0 ? profile[0].name : ""}</h2>
            <p className="font-bold text-2xl mb-2">{profile.length > 0 ? profile[0].email : ""}</p>
          ...
          <div className="w-full px-4 mb-12 md:w-1/4">
            ...
            <p className="text-slate-300 mb-3">
              Monday - Friday <br />
              at {openHours[0] && openHours[0].opening_time.slice(0, 5)} - {openHours[0] && openHours[0].closing_time.slice(0, 5)}
            </p>
            <p className="text-slate-300">
              Saturday - Sunday <br />
              at {openHours[4] && openHours[4].opening_time.slice(0, 5)} - {openHours[4] && openHours[4].closing_time.slice(0, 5)}
            </p>
          </div>
