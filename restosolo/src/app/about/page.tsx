        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-10 lg:w-1/2" data-aos="fade-right">
              ...
              <h3 className="font-semibold text-white text-2xl mb-4 lg:text-3xl lg:pt-10">About Us</h3>
            ...
            <div className="w-full px-4 lg:w-1/2" data-aos="fade-left">
              <h3 className="font-semibold text-white text-2xl mb-4 lg:text-3xl lg:pt-10">Warm Atmosphere</h3>
            ...
            <div className="w-full px-4 mb-10 lg:w-1/2" data-aos="fade-right">
              <h2 className="font-semibold text-white text-2xl mb-4 lg:text-3xl lg:pt-10">Historical Cuisine</h2>
              <p className="font-medium text-base text-white opacity-40 max-w-xl lg:text-lg">
            ...
            <div className="w-full px-4 lg:w-1/2" data-aos="fade-left">
              <h3 className="font-semibold text-white text-2xl mb-4 lg:text-3xl lg:pt-10">Our Team</h3>
              <p className="font-medium text-base text-white opacity-40  mb-6 lg:text-lg">
